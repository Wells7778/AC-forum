...
ActiveRecord::Schema.define(version: 20180415145808) do
  ...
  create_table "friendships", force: :cascade do |t|
    ...
    t.index ["friend_id"], name: "index_friendships_on_friend_id_and_friend_id"
    t.index ["user_id"], name: "index_friendships_on_user_id"
    t.index ["user_id"], name: "index_friendships_on_user_id_and_user_id"
  end
